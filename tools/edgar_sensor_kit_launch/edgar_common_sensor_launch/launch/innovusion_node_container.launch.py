...
def generate_launch_description():
    ...
    add_launch_arg("input_topic", description="Topic coming from innovusion driver")
    add_launch_arg("base_frame", "base_link", "base frame id")
    add_launch_arg("container_name", "innovusion_composable_node_container", "container name")
    add_launch_arg("frame_id", "innovusion", "innovusion lidar frame id")
